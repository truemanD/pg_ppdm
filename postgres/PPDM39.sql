...
\o /docker-entrypoint-initdb.d/PPDM39_output.txt
...
\qecho '======================================================================'
\i /docker-entrypoint-initdb.d/PPDM39_TAB.SQL
...
\qecho '======================================================================'
\i /docker-entrypoint-initdb.d/PPDM39_PK.SQL
...
\qecho '======================================================================'
\i /docker-entrypoint-initdb.d/PPDM39_CK.SQL
...
\qecho '======================================================================'
\i /docker-entrypoint-initdb.d/PPDM39_FK.SQL
...
\qecho '======================================================================'
\i /docker-entrypoint-initdb.d/PPDM39_OUOM.SQL
...
\qecho '======================================================================'
\i /docker-entrypoint-initdb.d/PPDM39_UOM.SQL
...
\qecho '======================================================================'
\i /docker-entrypoint-initdb.d/PPDM39_RQUAL.SQL
...
\qecho '======================================================================'
\i /docker-entrypoint-initdb.d/PPDM39_RSRC.SQL
...
\qecho '======================================================================'
\i /docker-entrypoint-initdb.d/PPDM39_TCM.SQL
...
\qecho '======================================================================'
\i /docker-entrypoint-initdb.d/PPDM39_CCM.SQL
...
\qecho '======================================================================'
\i /docker-entrypoint-initdb.d/PPDM39_GUID.SQL
